...
class LogCluster:
    def __init__(self):
        ...
        self.__events = self.__loader.load_sample_data()
    ...
    def analyze(self):
        ...
        print("클러스터 분석 결과:")
        print("-" * 50)
        metrics = self.__cluster_analyzer.analyze_cluster(self.__events)
        ...
        print("상세 분석 결과:")
        print("-" * 50)
        detailed_analysis = self.__cluster_analyzer.get_detailed_analysis(self.__events)
