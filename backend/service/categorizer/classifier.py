...
from _anomaly import StatisticalAnomalyDetector
...
class SecurityLogAnalyzer:
    ...
    def analyze(self, logs: List[Dict[str, Any]]) -> Dict[str, Any]:
        """로그 리스트 분석 (내부 함수)"""
        parsed_logs: List[LogEntry] = [LogEntry(**log) for log in logs]
        ...
        clusters = self.clusterer.cluster_events(parsed_logs, classifications)
